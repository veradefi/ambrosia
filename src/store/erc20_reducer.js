...
import erc20Abi from 'contracts/erc20/metadata.json';
import { erc20Address } from 'contracts/addresses.json';
    ...
    async (action,thunkAPI) => {
        try {
            ...
            if (connected && account) {
                ...
                thunkAPI.dispatch(updateErc20(CommonUtility.toUnit(output)));
            }
        } catch (error) {
